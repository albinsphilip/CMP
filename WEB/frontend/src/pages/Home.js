...
function Home() {
    ...
    <div className="slide">
        ...
        <div className="slide"> <h1> WELCOME TO RIT </h1></div>

        <div style={{
            backgroundColor: 'white', borderRadius: 4, color: 'black', minHeight: 200, padding: 12, width: 300
        }} >
                <p> beidwkjndoifhoaiJQWOfuhgnoqlw
                </p>
